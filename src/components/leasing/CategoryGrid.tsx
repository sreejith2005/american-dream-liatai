        ...
        {LEASING_CATEGORIES.map(category => {
          ...
          return (
            <button
              ...
              className={`px-5 py-2.5 md:px-6 md:py-2 rounded-full font-bebas text-base md:text-lg tracking-widest transition-colors duration-300 min-h-[44px] flex items-center ${
                isActive
